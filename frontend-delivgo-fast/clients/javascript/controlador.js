    ...
    if (btnRegister) {
        ...
        btnRegister.onclick = async function () {
            ...
            if (fetchResponse.code === 200 || fetchResponse.code === 201) {
                ...
                return window.location.href = '/clients/views-mods/M-DelivgoP1.html';
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = '/clients/views-mods/M-DelivgoP1.html';
...
const verifySession = async () => {
    ...
    if (fetchResponse.code === 401) {
        ...
        return Swal.fire({
                    ...
                    window.location.href = '../DelivGoSignin.html'      
...
const partialTotal = () => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = '/clients/DelivgoP3.html';
